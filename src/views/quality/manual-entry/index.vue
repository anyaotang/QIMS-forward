    ...
    <div class="page-table" style="max-width: 640px">
      <el-form ref="formRef" :model="formData" :rules="rules" label-width="120" class="entry-form">
        ...
        <el-form-item label="选择检测项" prop="itemId">
          <el-select v-model="formData.itemId" placeholder="请先选节点" style="width:100%" :disabled="!formData.nodeId">
        ...
        <el-form-item label="录入时间" prop="recordTime">
          <el-date-picker v-model="formData.recordTime" type="datetime" value-format="YYYY-MM-DD HH:mm:ss"
        ...
        <el-form-item>
          <el-button type="primary" :loading="submitting" size="large" style="width:200px" @click="handleSubmit">
            提交录入
          </el-button>
        </el-form-item>
      </el-form>
