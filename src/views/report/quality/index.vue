...
import { reportApi, nodeApi, extractData } from '@/utils/request'
...
const queryForm = reactive<ReportQuery>({
  page: 1, pageSize: 10, keyword: '', nodeId: undefined, itemId: undefined,
  startDate: '', endDate: '', isQualified: undefined,
})
...
function onReset() {
  Object.assign(queryForm, { page: 1, pageSize: 10, keyword: '', nodeId: undefined, itemId: undefined, startDate: '', endDate: '', isQualified: undefined })
  loadTable()
}
    ...
    <div class="page-filter">
      <el-form :inline="true" :model="queryForm">
        ...
        <el-form-item label="合格状态">
          <el-select v-model="queryForm.isQualified" placeholder="全部" clearable style="width:120px">
    ...
    <div class="page-table">
      <el-table :data="tableData" v-loading="loading" stripe>
        ...
        <el-table-column label="偏差率(%)" width="100">
          <template #default="{ row }"><span :class="getCellClass(row)">{{ row.deviationRate }}%</span></template>
        </el-table-column>
